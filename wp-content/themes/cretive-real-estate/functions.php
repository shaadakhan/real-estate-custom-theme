...
?>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xm-12 item-space">
		<div class="property-container">
			<a href="<?php echo get_the_permalink($proper_id) ?>">
				...
				<div class="col-lg-12">
					<div class="d-flex justify-content-center align-items-center flex-column m-auto">
						<h1>
							...
							} elseif (is_single() && get_post_type() == 'property') {
		...
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-warning alert-dismissible fade show" role="alert">
					<strong>found with your search critearea...!</strong>
